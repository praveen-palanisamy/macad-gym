...
ENV_CONFIG = {
    ...
    "scenarios": [DEFAULT_SCENARIO_TOWN2],
    ...
    def init_server(self):
        ...
        if not self.config["render"] and ( gpus is not None and len(gpus) ) > 0:
            ...
            self.server_process = subprocess.Popen(
                ("DISPLAY=:8 vglrun -d :7.{} {} "+self.config["server_map"]+" -windowed -ResX=400 -ResY=300 -carla-server -carla-world-port={}").format(min_index, SERVER_BINARY, self.server_port),
